                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary"><a href="/fanclub_activity/joinfanart2.php?fanartid='.$fid->getFanID().'&uid='.$uid->getGID().'" class="text-light">เข้าร่วม</a></button>
