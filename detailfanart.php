...
<body>
   ...
   // $join = new JoinFan();    
    echo '<button type="button" class="btn btn-info"  data-bs-toggle="modal" data-bs-target="#exampleModal"><a class="text-light">เข้าร่วมกิจกรรม</a></button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">คุณต้องการเข้าร่วมกิจกรรมนี้ใช่หรือไม่?</h5>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary"><a href="/fanclub_activity/joinfanart.php?fanartid='.$fid->getFanID().'&uid='.$uid->getGID().'" class="text-light">เข้าร่วม</a></button>
...
<?php
            ...
            //    echo "ศิลปิน:  ";
            //    echo $artistName = $activity->getartistName();
       
            //    echo "วันที่เริ่มงาน:  ";
            //    echo $eventdate = $activity->geteventDate();
            //    echo "เวลาเริ่มงาน:  ".$timeevent = $activity->getTimeEvent()."\r";
            ...
            //    echo "จำนวนบูธ:  ";
            //    echo $NumofBooth = $fan->getNumofBooth();   
            //    echo "จำนวนโซนบูธ:  ";
            //    echo $eventT = $fan->getNumofZone();     
